...
let snakeNextDir = null; // Add this line near other snake variables
const SNAKE_SIZE = 16;
const SNAKE_GRID = 20;
...
function startSnakeGame() {
    ...
    snake = [{x: 10, y: 10}];
    snakeDir = {x: 1, y: 0};
    snakeNextDir = null; // Reset queued direction
    snakeScore = 0;
    snakeDead = false;
...
document.addEventListener('keydown', function(e) {
    ...
    // Only queue a direction if not already queued for this tick
    if (!snakeNextDir) {
